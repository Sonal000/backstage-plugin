...
export var DynatraceQueryKeys;
(function (DynatraceQueryKeys) {
    DynatraceQueryKeys["KUBERNETES_DEPLOYMENTS"] = "kubernetes-deployments";
    DynatraceQueryKeys["SRG_VALIDATIONS"] = "srg-validations";
})(DynatraceQueryKeys || (DynatraceQueryKeys = {}));
export const isValidDynatraceQueryKey = (key) => key in dynatraceQueries;
export const dynatraceQueries = {
    [DynatraceQueryKeys.KUBERNETES_DEPLOYMENTS]: (entity, apiConfig) => {
        ...
        const filterKubernetesId = filterLabel || !kubernetesId
            ? ''
        ...
        if (!filterKubernetesId && !filterLabel) {
            throw new Error('One of the component annotations is required: "backstage.io/kubernetes-id" or "backstage.io/kubernetes-label-selector"');
        }
        return `
