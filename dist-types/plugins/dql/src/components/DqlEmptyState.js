...
export const DqlEmptyState = ({ componentName, queryName, queryNamespace, additionalInformation = '', }) => {
  ...
  ${additionalInformation}`;
    return React.createElement(DynatraceMarkdownText, { content: message });
};
