...
describe('label-parser', () => {
    it('should correctly parse labels', () => {
        // act
        const filter = generateKubernetesSelectorFilter('label1=value1,label2=value2');
        // assert
        expect(filter).toBe('| filter workload.labels[`label1`] == "value1" AND workload.labels[`label2`] == "value2"');
    });
