...
export const EntityDqlQueryCard = dqlQueryPlugin.provide(createComponentExtension({
    name: 'EntityDqlQueryCard',
    component: {
        lazy: () => import('./components').then(m => m.DqlQuery),
    },
}));
export const EntityCatalogInfoQueryCard = dqlQueryPlugin.provide(createComponentExtension({
    name: 'EntityCatalogInfoQueryCard',
    component: {
        lazy: () => import('./components').then(m => m.CatalogInfoQuery),
    },
}));
export const EntityKubernetesDeploymentsCard = dqlQueryPlugin.provide(createComponentExtension({
